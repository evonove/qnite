...
private slots:
    ...
    void testBuildTicksDefault()
    {
      ...
      QList<qreal> l2 {0.2, 0.4, 0.6, 0.8, 1.2, 1.4, 1.6, 1.8, 2.2, 2.4, 2.6,
                       2.8, 3.2, 3.4, 3.6, 3.8, 4.2, 4.4, 4.6, 4.8, 5.2, 5.4,
                       5.6, 5.8, 6.2, 6.4, 6.6, 6.8, 7.2, 7.4, 7.6, 7.8, 8.2,
                       8.4, 8.6, 8.8, 9.2, 9.4, 9.6, 9.8};
      QCOMPARE(ticker.minorTicks(), l2);
    }
